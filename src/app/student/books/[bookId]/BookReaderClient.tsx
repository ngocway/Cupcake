      ...
      <div className="flex-1 min-h-0 w-full max-w-6xl mx-auto flex flex-col md:flex-row md:items-center md:justify-center md:px-20 relative overflow-hidden">
        ...
        <div className="w-full flex-1 min-h-0 md:h-[90%] md:max-h-[calc(100vh-210px)] md:rounded-[48px] md:bg-white md:border-8 md:border-emerald-300 flex flex-col md:flex-row md:gap-6 md:p-6 overflow-hidden md:shadow-[0_24px_50px_rgba(16,185,129,0.18)] relative">
          ...
          <div className="fixed top-[25%] left-1/2 -translate-x-1/2 z-20 w-[94vw] flex flex-col items-center md:static md:top-auto md:left-auto md:translate-x-0 md:w-auto md:items-start md:flex-1 md:min-h-0 md:h-full md:justify-center md:overflow-y-auto custom-scrollbar md:px-0 md:pr-2 md:py-3">
            <div className="w-full bg-[linear-gradient(135deg,rgba(21,101,192,0.2),rgba(13,71,161,0.2))] backdrop-blur-md rounded-2xl px-5 py-3 md:px-7 md:py-5">
              <div className="flex flex-col gap-2 font-headline font-black leading-snug text-white md:text-amber-950 text-center md:text-left text-[clamp(1.65rem,3.3vw,3.3rem)] md:text-[clamp(0.95rem,1.9vw,1.9rem)] [text-shadow:-2px_-2px_0_#000,2px_-2px_0_#000,-2px_2px_0_#000,2px_2px_0_#000] md:[text-shadow:none]">
                {(() => {
