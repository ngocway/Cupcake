      ...
      <div className="space-y-4">
          ...
          <div className="sticky bottom-6 flex justify-end z-[40] pointer-events-none pt-2 w-full h-fit">
            <button
              ...
              onClick={handleSave}
              disabled={isSaving}
              className="pointer-events-auto h-auto min-h-0 w-fit max-w-fit px-6 py-3 sm:px-7 sm:py-3.5 bg-gradient-to-r from-rose-600 via-pink-600 to-rose-700 hover:from-rose-700 hover:to-pink-700 active:scale-95 text-white font-black text-xs sm:text-sm uppercase tracking-wider rounded-full shadow-xl shadow-rose-900/40 hover:shadow-rose-900/60 border border-white/30 backdrop-blur-md transition-all duration-300 flex items-center justify-center gap-2.5 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed group hover:scale-105"
              title="Lưu bài tập"
            >
              {isSaving ? (
