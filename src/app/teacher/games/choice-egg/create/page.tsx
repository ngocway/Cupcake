  ...
  return (
    <HomeShell>
      <div className="w-full pb-20 px-4 md:px-10 max-w-[1200px] mx-auto select-none">
        ...
        {step === 2 && (
          <button
            ...
            disabled={isSaving}
            className="fixed bottom-6 right-6 z-50 px-6 py-3 sm:px-7 sm:py-3.5 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 hover:from-amber-600 hover:to-orange-600 active:scale-95 text-white font-black text-xs sm:text-sm uppercase tracking-wider rounded-full shadow-2xl shadow-amber-500/50 border border-white/30 backdrop-blur-md transition-all duration-300 flex items-center justify-center gap-2.5 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed group hover:scale-105"
            title="Lưu bài tập"
          >
            {isSaving ? (
      ...
      <GameSaveSuccessModal
        ...
        title={gameTitle}
        gameType="Đập Trứng Toán Học"
        gameCode={createdCode}
        playUrl={`/game/egg-smash/${createdCode}`}
