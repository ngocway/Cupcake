  ...
  return (
    <div className="bg-white/95 dark:bg-slate-900/90 backdrop-blur-md rounded-3xl border border-primary/10 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col group">
      ...
      <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between bg-white dark:bg-slate-900">
        <div>
          <h3
            className={`font-headline font-black text-base sm:text-lg mb-1.5 leading-snug line-clamp-2 ${
        ...
        <Link
          href={href}
          prefetch={true}
          className="w-full py-3 px-3.5 bg-rose-500 hover:bg-rose-600 active:scale-95 text-white font-black text-xs uppercase tracking-wider rounded-2xl shadow-lg shadow-rose-500/20 transition-all flex items-center justify-center gap-2 group/btn text-center"
        >
