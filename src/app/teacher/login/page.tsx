...
export default function LoginPage() {
  ...
  return (
    <main className="flex-grow flex flex-col md:flex-row items-stretch min-h-screen bg-surface font-body text-on-surface antialiased">
      ...
      <div className="w-full md:w-1/2 bg-surface-container-lowest flex flex-col justify-center px-6 py-12 md:px-24 relative">
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="md:hidden mb-12 flex flex-col items-center">
            ...
            <p className="text-sm text-on-surface-variant font-label">EngMaster Teacher Portal</p>
          </div>

          {/* Toggle Navigation */}
          <div className="flex gap-8 mb-10 border-b border-outline-variant/15">
            <button className="pb-4 border-b-2 border-primary text-primary font-headline font-bold text-lg">
              Log In
            </button>
            <button className="pb-4 border-b-2 border-transparent text-on-surface-variant hover:text-on-surface font-headline font-medium text-lg transition-colors">
              Sign Up
            </button>
          </div>
          ...
          {/* Social Login */}
          <button className="w-full py-4 px-6 mb-8 flex items-center justify-center gap-3 bg-surface-container-lowest border border-outline-variant rounded-xl font-label font-bold text-on-surface hover:bg-surface-container-low transition-all duration-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-surface-variant/30 border-none rounded-xl focus:ring-2 focus:ring-primary/20 focus:bg-surface-container-lowest transition-all duration-300 font-body placeholder:text-outline" 
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <a className="text-xs font-label text-primary font-bold hover:underline" href="#">Forgot Password?</a>
              </div>
              <div className="relative">
                ...
                <input 
                  ...
                  required
                  placeholder="••••••••" 
                  className="w-full pl-12 pr-12 py-4 bg-surface-variant/30 border-none rounded-xl focus:ring-2 focus:ring-primary/20 focus:bg-surface-container-lowest transition-all duration-300 font-body placeholder:text-outline" 
                />
                <button 
            ...
            <div className="flex items-center gap-3 py-2">
              ...
              <label className="font-body text-sm text-on-surface-variant" htmlFor="remember">Keep me logged in for 30 days</label>
            </div>
        ...
        {/* Support Access (Sticky Help as Trailing Primary Action Reference) */}
        <button className="absolute bottom-8 right-8 bg-surface-container-lowest p-4 rounded-full shadow-[0_8px_24px_rgba(25,27,35,0.06)] text-primary hover:text-primary-container transition-all group flex items-center">
