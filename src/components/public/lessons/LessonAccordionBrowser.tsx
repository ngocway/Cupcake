        ...
        return (
          ...
          >
            ...
            >
              ...
              {!isOpen && (
                <span className={`shrink-0 px-2 py-0.5 sm:px-3 sm:py-1 text-[10px] sm:text-xs font-black rounded-full transition-all duration-300 group-hover/accordion:scale-105 whitespace-nowrap ${config.tagBg} ${isLoading && levelLessons.length === 0 ? 'animate-pulse' : ''}`}>
                  {countLabel}
                </span>
              )}
